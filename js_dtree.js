...
//This code is add. Y.Shindin. Opens the tree to a specific node URL
dTree.prototype.openToURL = function(nURL, bSelect, bFirst) {
	if (!bFirst) {
		for (var n=0; n<this.aNodes.length; n++) {
...
//Execute a link
dTree.prototype.golink = function(linkto) {
parent.main.location.href=linkto;
return false;
};
